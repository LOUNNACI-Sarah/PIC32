...
/* Setting for class-2 analog inputs */
     ...
     PLIB_ADCHS_EarlyInterruptDisable(DRV_ADC_ID_1);
    PLIB_ADCHS_AnalogInputEarlyInterruptEnable(DRV_ADC_ID_1, ADCHS_CLASS2_AN5);
...
inline void DRV_ADC_DigitalComparator4_Open(void)
{
...
inline void DRV_ADC_DigitalComparator4_Close(void)
{
...
inline bool DRV_ADC_DigitalComparator4_EventHasOccurred(void)
{
...
inline void DRV_ADC_DigitalFilter4_Open(void)
{
     /* Enable digital comparator */
...
inline void DRV_ADC_DigitalFilter4_Close(void)
{
     /* Disable digital comparator */
...
inline bool DRV_ADC_DigitalFilter4_DataIsReady(void)
{
...
inline int16_t DRV_ADC_DigitalFilter4_DataRead(void)
{
