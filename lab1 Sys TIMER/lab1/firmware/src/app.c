    ...
    switch ( appData.state )
    {
        ...
        case APP_STATE_INIT:
        {
            ...
            if (appInitialized)
            {
                ...
                appData.sysTmrHandle1 = SYS_TMR_CallbackPeriodic(500, 0, &APP_Tmr_Sys_Service_Callback_Delay1);

                appData.sysTmrHandle1 = SYS_TMR_CallbackPeriodic(2000, 0, &APP_Tmr_Sys_Service_Callback_Delay2);
        ...
        case APP_STATE_SERVICE_TASKS:
        {
            ...
            {
                BSP_LEDToggle(BSP_LED_1_CHANNEL,BSP_LED_1_PORT);
                appData.delay1Expired = false;
            }

            if(appData.delay2Expired == true)
            {
                BSP_LEDToggle(BSP_LED_2_CHANNEL,BSP_LED_2_PORT);
                appData.delay2Expired = false;
            }
